 ...
 *
 * @class SkyHSHOSO_Email_New_Switch_Order
 * @version 1.0.0
 * @package SkyHS Hosting Solution/Classes/Emails
 * @extends WC_Email_New_Order
 */
class SkyHSHOSO_Email_New_Switch_Order extends WC_Email_New_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'Subscription Switched', 'skyhs-hosting-solution' );
		$this->description    = __( 'Subscription switched emails are sent when a customer switches a subscription.', 'skyhs-hosting-solution' );

		$this->heading        = __( 'Subscription Switched', 'skyhs-hosting-solution' );
		$this->subject        = __( '[{blogname}] Subscription Switched ({order_number}) - {order_date}', 'skyhs-hosting-solution' );
