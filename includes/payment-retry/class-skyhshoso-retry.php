 ...
 * @subpackage  SkyHSHOSO_Retry
 * @category    Class
 * @since       2.1
 */

class SkyHSHOSO_Retry {
	...
	/* an instance of the retry rules (SkyHSHOSO_Retry_Rule by default) applied for this retry */
	protected $rule;
	...
	public function update_status( $new_status ) {
		...
		SkyHSHOSO_Retry_Manager::store()->save( new SkyHSHOSO_Retry( array(
			'id'       => $this->get_id(),
		...
		do_action( 'skyhshoso_retry_status_updated', $this, $new_status, $old_status );
	}
	...
	public function update_date_gmt( $new_date ) {
		...
		do_action( 'skyhshoso_retry_date_updated', $this, $new_date, $old_date );
	}
	 ...
	 *
	 * @return SkyHSHOSO_Retry_Rule
	 */
	public function get_rule() {

		if ( null === $this->rule ) {
			$rule_class = SkyHSHOSO_Retry_Manager::rules()->get_rule_class();
