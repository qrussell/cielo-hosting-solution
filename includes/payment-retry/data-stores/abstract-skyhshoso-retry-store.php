...
abstract class SkyHSHOSO_Retry_Store {
	 ...
	 */
	abstract public function save( SkyHSHOSO_Retry $retry );
	...
	public function delete_retry( $retry_id ) {
		wc_doing_it_wrong( __FUNCTION__, sprintf( "Method '%s' must be overridden.", __METHOD__ ), '2.4' );
	}
