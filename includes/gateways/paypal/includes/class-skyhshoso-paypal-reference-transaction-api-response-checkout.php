<?php
/**
 * SkyHS Hosting Solution PayPal Reference Transaction API Response Class for Express Checkout API calls
 *
...
class SkyHSHOSO_PayPal_Reference_Transaction_API_Response_Checkout extends SkyHSHOSO_PayPal_Reference_Transaction_API_Response {
