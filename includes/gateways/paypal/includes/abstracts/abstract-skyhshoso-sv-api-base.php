<?php
/**
 * PayPal API Base Class
 *
 * Provides a standardized framework for constructing an API wrapper
 * to external services.
 *
 * @package   SkyHS Hosting Solution/PayPal
 ...
 * @version 1.0.0
 */
abstract class SkyHSHOSO_SV_API_Base {
	...
	protected function get_request_uri() {
		 ...
		 * @param \SkyHSHOSO_SV_API_Base class instance
		 */
